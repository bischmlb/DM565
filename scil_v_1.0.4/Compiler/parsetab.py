...
_lr_productions = [
  ...
  ('body -> optional_variables_declaration_sequence optional_functions_declaration_list statement_list','body',3,'p_body','lexer_parser.py',126),
  ('optional_variables_declaration_sequence -> empty','optional_variables_declaration_sequence',1,'p_optional_variables_declaration_sequence','lexer_parser.py',131),
  ('optional_variables_declaration_sequence -> variables_declaration_sequence','optional_variables_declaration_sequence',1,'p_optional_variables_declaration_sequence','lexer_parser.py',132),
  ('variables_declaration_sequence -> VAR variables_list','variables_declaration_sequence',2,'p_variables_declaration_sequence','lexer_parser.py',137),
  ('variables_declaration_sequence -> VAR variables_list variables_declaration_sequence','variables_declaration_sequence',3,'p_variables_declaration_sequence','lexer_parser.py',138),

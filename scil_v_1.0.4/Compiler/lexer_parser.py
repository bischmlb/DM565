...
def p_body(t):
    'body : optional_variables_declaration_sequence optional_functions_declaration_list statement_list'
    t[0] = AST.body(t[1], t[2], t[3], t.lexer.lineno)


def p_optional_variables_declaration_sequence(t):
    '''optional_variables_declaration_sequence : empty
                                               | variables_declaration_sequence'''
    t[0] = t[1]


def p_variables_declaration_sequence(t):
    '''variables_declaration_sequence : VAR variables_list
                                      | VAR variables_list variables_declaration_sequence'''
    if len(t) == 3:
        t[0] = AST.variables_declaration_sequence(t[2], None, t.lexer.lineno)
    else:
        t[0] = AST.variables_declaration_sequence(t[2], t[3], t.lexer.lineno)

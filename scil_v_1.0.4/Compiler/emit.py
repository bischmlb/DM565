...
class Emit:
    ...
    """
    def __init__(self, intermediate_representation, labels):
    ...
    def call_printf(self):
        self._ins("", "PRINTING")
        self._ins("movq $form, %rdi", "pass 1. argument in %rdi")
        ...
        self._ins("call printf", "call function printf")
